...
// Sun Aug 25 16:24:29 2013 by ROOT version 5.99/02
// from TTree selectedObjects/Selected objects
...
public :
   ...
   UInt_t          eventNumber;
   UInt_t          photon_size;
   Float_t         photon_pt[3];   //[photon.size]
   Float_t         photon_eta[3];   //[photon.size]
   Float_t         photon_phi[3];   //[photon.size]
   Float_t         photon_px[3];   //[photon.size]
   Float_t         photon_py[3];   //[photon.size]
   Float_t         photon_pz[3];   //[photon.size]
   Float_t         photon_energy[3];   //[photon.size]
   Float_t         photon_hOverE[3];   //[photon.size]
   Float_t         photon_sigmaIetaIeta[3];   //[photon.size]
   Float_t         photon_sigmaIphiIphi[3];   //[photon.size]
   Float_t         photon_etaWidth[3];   //[photon.size]
   Float_t         photon_phiWidth[3];   //[photon.size]
   Float_t         photon_r9[3];   //[photon.size]
   Float_t         photon_r5[3];   //[photon.size]
   Float_t         photon_trackerIso[3];   //[photon.size]
   Float_t         photon_ecalIso[3];   //[photon.size]
   Float_t         photon_hcalIso[3];   //[photon.size]
   Float_t         photon_chargedHadronIso[3];   //[photon.size]
   Float_t         photon_neutralHadronIso[3];   //[photon.size]
   Float_t         photon_photonIso[3];   //[photon.size]
   Short_t         photon_iSubdet[3];   //[photon.size]
   UChar_t         photon_nPixelSeeds[3];   //[photon.size]
   UChar_t         photon_nClusters[3];   //[photon.size]
   Bool_t          photon_hasMatchedElectron[3];   //[photon.size]
   Bool_t          photon_electronVetoBit[3];   //[photon.size]
   Bool_t          photon_looseElectronVetoBit[3];   //[photon.size]
   Bool_t          photon_isLoose[3];   //[photon.size]
   Bool_t          photon_isMedium[3];   //[photon.size]
   Bool_t          photon_isTight[3];   //[photon.size]
   Bool_t          photon_isLoosePix[3];   //[photon.size]
   Bool_t          photon_isMediumPix[3];   //[photon.size]
   Bool_t          photon_isTightPix[3];   //[photon.size]
   Bool_t          photon_isLooseLV[3];   //[photon.size]
   Bool_t          photon_isMediumLV[3];   //[photon.size]
   Bool_t          photon_isTightLV[3];   //[photon.size]
   UInt_t          electron_size;
   Float_t         electron_pt[3];   //[electron.size]
   Float_t         electron_eta[3];   //[electron.size]
   Float_t         electron_phi[3];   //[electron.size]
   Float_t         electron_px[3];   //[electron.size]
   Float_t         electron_py[3];   //[electron.size]
   Float_t         electron_pz[3];   //[electron.size]
   Float_t         electron_energy[3];   //[electron.size]
   Float_t         electron_combRelSubdetIso[3];   //[electron.size]
   Float_t         electron_combRelIso[3];   //[electron.size]
   Float_t         electron_deltaEta[3];   //[electron.size]
   Float_t         electron_deltaPhi[3];   //[electron.size]
   Float_t         electron_sigmaIetaIeta[3];   //[electron.size]
   Float_t         electron_sigmaIphiIphi[3];   //[electron.size]
   Float_t         electron_r9[3];   //[electron.size]
   Float_t         electron_r5[3];   //[electron.size]
   Float_t         electron_etaWidth[3];   //[electron.size]
   Float_t         electron_phiWidth[3];   //[electron.size]
   Float_t         electron_hOverE[3];   //[electron.size]
   Float_t         electron_d0[3];   //[electron.size]
   Float_t         electron_dz[3];   //[electron.size]
   Float_t         electron_epDiff[3];   //[electron.size]
   Float_t         electron_vtxFitProb[3];   //[electron.size]
   Float_t         electron_dCot[3];   //[electron.size]
   Float_t         electron_dist[3];   //[electron.size]
   Short_t         electron_iSubdet[3];   //[electron.size]
   UChar_t         electron_nClusters[3];   //[electron.size]
   UChar_t         electron_nPixelHits[3];   //[electron.size]
   UChar_t         electron_nMissingHits[3];   //[electron.size]
   Bool_t          electron_passConversionVeto[3];   //[electron.size]
   Bool_t          electron_isVeto[3];   //[electron.size]
   Bool_t          electron_isLoose[3];   //[electron.size]
   Bool_t          electron_isMedium[3];   //[electron.size]
   Bool_t          electron_isTight[3];   //[electron.size]
   UInt_t          muon_size;
   Float_t         muon_pt[2];   //[muon.size]
   Float_t         muon_eta[2];   //[muon.size]
   Float_t         muon_phi[2];   //[muon.size]
   Float_t         muon_px[2];   //[muon.size]
   Float_t         muon_py[2];   //[muon.size]
   Float_t         muon_pz[2];   //[muon.size]
   Float_t         muon_energy[2];   //[muon.size]
   Float_t         muon_normChi2[2];   //[muon.size]
   Float_t         muon_dxy[2];   //[muon.size]
   Float_t         muon_dz[2];   //[muon.size]
   Float_t         muon_combRelSubdetIso[2];   //[muon.size]
   Float_t         muon_combRelIso[2];   //[muon.size]
   Short_t         muon_iSubdet[2];   //[muon.size]
   UChar_t         muon_nMatchedStations[2];   //[muon.size]
   UChar_t         muon_nLayersWithMmt[2];   //[muon.size]
   UChar_t         muon_nValidMuonHits[2];   //[muon.size]
   UChar_t         muon_nValidPixelHits[2];   //[muon.size]
   Bool_t          muon_isGlobalMuon[2];   //[muon.size]
   Bool_t          muon_isPFMuon[2];   //[muon.size]
   Bool_t          muon_hasInnerTrack[2];   //[muon.size]
   Bool_t          muon_hasGlobalTrack[2];   //[muon.size]
   Bool_t          muon_hasBestTrack[2];   //[muon.size]
   Bool_t          muon_isLoose[2];   //[muon.size]
   Bool_t          muon_isTight[2];   //[muon.size]
   UInt_t          jet_size;
   Float_t         jet_pt[17];   //[jet.size]
   Float_t         jet_eta[17];   //[jet.size]
   Float_t         jet_phi[17];   //[jet.size]
   Float_t         jet_px[17];   //[jet.size]
   Float_t         jet_py[17];   //[jet.size]
   Float_t         jet_pz[17];   //[jet.size]
   Float_t         jet_energy[17];   //[jet.size]
   Float_t         jet_jecScale[17];   //[jet.size]
   Float_t         jet_chFraction[17];   //[jet.size]
   Float_t         jet_nhFraction[17];   //[jet.size]
   Float_t         jet_ceFraction[17];   //[jet.size]
   Float_t         jet_neFraction[17];   //[jet.size]
   Short_t         jet_iSubdet[17];   //[jet.size]
   UChar_t         jet_nConstituents[17];   //[jet.size]
   UChar_t         jet_nCharged[17];   //[jet.size]
   Bool_t          jet_isLoose[17];   //[jet.size]
   UInt_t          vertex_size;
   Float_t         vertex_x[36];   //[vertex.size]
   Float_t         vertex_y[36];   //[vertex.size]
   Float_t         vertex_z[36];   //[vertex.size]
   Float_t         vertex_rho[36];   //[vertex.size]
   Float_t         vertex_sumPt2[36];   //[vertex.size]
   Float_t         vertex_chi2[36];   //[vertex.size]
   Float_t         vertex_ndof[36];   //[vertex.size]
   Bool_t          vertex_isGood[36];   //[vertex.size]
   Float_t         photon_dRGen[3];   //[photon.size]
   Float_t         photon_genIso[3];   //[photon.size]
   Int_t           photon_nearestGen[3];   //[photon.size]
   Float_t         photon_dRJet[3];   //[photon.size]
   Float_t         photon_dRNextJet[3];   //[photon.size]
   Float_t         photon_dRPF[3];   //[photon.size]
   Short_t         photon_nearestPF[3];   //[photon.size]
   Bool_t          photon_pfIsPU[3];   //[photon.size]
   Float_t         electron_dRGen[3];   //[electron.size]
   Float_t         electron_genIso[3];   //[electron.size]
   Int_t           electron_nearestGen[3];   //[electron.size]
   Float_t         electron_dRJet[3];   //[electron.size]
   Float_t         electron_dRNextJet[3];   //[electron.size]
   Float_t         electron_dRPhoton[3];   //[electron.size]
   Float_t         electron_dRNextPhoton[3];   //[electron.size]
   Float_t         electron_dRPF[3];   //[electron.size]
   Short_t         electron_nearestPF[3];   //[electron.size]
   Bool_t          electron_pfIsPU[3];   //[electron.size]
   Float_t         muon_dRGen[2];   //[muon.size]
   Float_t         muon_genIso[2];   //[muon.size]
   Int_t           muon_nearestGen[2];   //[muon.size]
   Float_t         muon_dRJet[2];   //[muon.size]
   Float_t         muon_dRNextJet[2];   //[muon.size]
   Float_t         muon_dRPhoton[2];   //[muon.size]
   Float_t         muon_dRNextPhoton[2];   //[muon.size]
   Float_t         muon_dRPF[2];   //[muon.size]
   Short_t         muon_nearestPF[2];   //[muon.size]
   Bool_t          muon_pfIsPU[2];   //[muon.size]
   Float_t         jet_dRGen[17];   //[jet.size]
   Float_t         jet_genSumPt[17];   //[jet.size]
   Int_t           jet_nearestGen[17];   //[jet.size]
   ...
   selectedObjects(TTree *tree=0);
   virtual ~selectedObjects();
...
#ifdef selectedObjects_cxx
selectedObjects::selectedObjects(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      f->GetObject("selectedObjects",tree);
...
Int_t selectedObjects::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t selectedObjects::LoadTree(Long64_t entry)
{
...
void selectedObjects::Init(TTree *tree)
{
...
void selectedObjects::Show(Long64_t entry)
{
...
Int_t selectedObjects::Cut(Long64_t entry)
{
...
#endif // #ifdef selectedObjects_cxx
